package com.tsybulka.logbase.entity;

import com.tsybulka.logbase.comparator.TruckComparator;
...
public class LogisticBase extends Thread {
    ...
    private static final Logger LOGGER = LogManager.getLogger(String.valueOf(LogisticBase.class));
    ...
    private LogisticBase() {
        ...
        setName(threadName);
        Comparator<Truck> comparator = new TruckComparator();
        ...
        LOGGER.log(INFO, "Logistic base has been created");
    }
                ...
                if (terminal != null) {
                    ...
                    while (!isServiced && attemptCounter < MAX_ATTEMPTS_NUMBER) {
                        if (terminal.service()) {
                            ...
                            LOGGER.log(INFO, "Truck " + truck.getId() + " has been serviced");
                        } else {
